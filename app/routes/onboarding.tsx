...
import { Cloud, ArrowRight, Building2, FolderGit2, Check } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-[#e3e3e3] flex flex-col">
      ...
      <div className="max-w-lg mx-auto w-full px-8 pt-12">
        <div className="onboard-fade flex items-center gap-3 mb-12">
          <div className={`flex items-center gap-2 text-[13px] font-medium ${step === "org" ? "text-[#f38020]" : "text-[#555]"}`}>
            <div className={`w-7 h-7 rounded-full flex items-center justify-center text-[12px] font-semibold ${
              step === "org" ? "bg-[#f38020] text-white" : "bg-[#1a1a1a] border border-[#333] text-[#555]"
            }`}>
          ...
          <div className={`flex items-center gap-2 text-[13px] font-medium ${step === "project" ? "text-[#f38020]" : "text-[#555]"}`}>
            <div className={`w-7 h-7 rounded-full flex items-center justify-center text-[12px] font-semibold ${
              step === "project" ? "bg-[#f38020] text-white" : "bg-[#1a1a1a] border border-[#333] text-[#555]"
            }`}>
              2
            </div>
            Project
      ...
      <div ref={stepRef} className="max-w-lg mx-auto w-full px-8 flex-1">
        {step === "org" && (
          <div>
            ...
            <p className="step-item text-[14px] text-[#666] mb-8">
              An organization groups your infrastructure projects together. Use your name or team name.
            </p>
        ...
        {step === "project" && (
          <div>
            ...
            <p className="step-item text-[14px] text-[#666] mb-8">
              Each project represents an infrastructure deployment with its own canvas and generated code.
              You'll choose a cloud provider inside the editor.
            </p>
